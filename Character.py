...
class Character:
    def __init__(self, config_path='character.json'):
        ...
        self.crop_table = {
            'single': {
                '16:10': [2160, 490, 2355, 540],
                '16:9': [2160, 325, 2355, 375]
            },
            'double': {
                '16:10': [2160, 690, 2355, 740],
                '16:9': [2160, 540, 2355, 590]
            },
            'three': {
                '16:10': [2160, 825, 2355, 875],
                '16:9': [2160, 665, 2355, 715]
            },
            'four': {
                '16:10': [2160, 885, 2355, 935],
                '16:9': [2160, 725, 2355, 775]
            },
            'burst': {
                '16:10': [2350, 1380, 2502, 1530],
                '16:9': [2350, 1220, 2502, 1370]
            }
        }
